...
fixes['inva-wp-es'] = {
    ...
    'replacements': [
        ...
        (ur'(?i)({{[\s_]*(?:plantilla[\s_]*:|template[\s_]*:)?[\s_]*cita[ _](?:libro|noticia|publicación|web)[^}]*?ubicación\s*=\s*)(?:m[éeè][jx]ico,? ?d\.? ?f\.?|mexico city)(\s*[}\|])', ur'\1México,&nbsp;D.&nbsp;F.\2'),
        ...
        # Estandarizar y traducir fechas al español
            # En plantillas de citas
                ...
                (ur'(?i)({{[\s_]*cita[ _](?:libro|noticia|publicación|web)[^}]*?(?:fecha|fechaacceso|fechaarchivo)\s*=\s*\d\d?)(?:[\s\-/]| de )(?:en[éeè](?:ro)?|jan(?:uar[iy])?|janvier)[\s\-/,]+([12]\d\d\d)(\s*[}\|])', ur'\1 de enero de \2\3'),
                (ur'(?i)({{[\s_]*cita[ _](?:libro|noticia|publicación|web)[^}]*?(?:fecha|fechaacceso|fechaarchivo)\s*=\s*\d\d?)(?:[\s\-/]| de )(?:feb(?:r[éeè]ro)?|februar[iy]|f[éeè]v(?:rier)?)[\s\-/,]+([12]\d\d\d)(\s*[}\|])', ur'\1 de febrero de \2\3'),
                (ur'(?i)({{[\s_]*cita[ _](?:libro|noticia|publicación|web)[^}]*?(?:fecha|fechaacceso|fechaarchivo)\s*=\s*\d\d?)(?:[\s\-/]| de )(?:m[áaà]r(?:zo)?|march|mars)[\s\-/,]+([12]\d\d\d)(\s*[}\|])', ur'\1 de marzo de \2\3'),
                (ur'(?i)({{[\s_]*cita[ _](?:libro|noticia|publicación|web)[^}]*?(?:fecha|fechaacceso|fechaarchivo)\s*=\s*\d\d?)(?:[\s\-/]| de )(?:abr(?:[íiì]l)?|apr(?:il)?|avr(?:il)?)[\s\-/,]+([12]\d\d\d)(\s*[}\|])', ur'\1 de abril de \2\3'),
                ...
                (ur'(?i)({{[\s_]*cita[ _](?:libro|noticia|publicación|web)[^}]*?(?:fecha|fechaacceso|fechaarchivo)\s*=\s*\d\d?)(?:[\s\-/]| de )(?:j[úuù]n(?:io)?|jun[ei]|juin)[\s\-/,]+([12]\d\d\d)(\s*[}\|])', ur'\1 de junio de \2\3'),
                (ur'(?i)({{[\s_]*cita[ _](?:libro|noticia|publicación|web)[^}]*?(?:fecha|fechaacceso|fechaarchivo)\s*=\s*\d\d?)(?:[\s\-/]| de )(?:j[úuù]l(?:io)?|jul[iy]|juil(?:let)?)[\s\-/,]+([12]\d\d\d)(\s*[}\|])', ur'\1 de julio de \2\3'),
                (ur'(?i)({{[\s_]*cita[ _](?:libro|noticia|publicación|web)[^}]*?(?:fecha|fechaacceso|fechaarchivo)\s*=\s*\d\d?)(?:[\s\-/]| de )(?:ag[óoò](?:sto)?|aug(?:usti?)?|ao[ûu]t)[\s\-/,]+([12]\d\d\d)(\s*[}\|])', ur'\1 de agosto de \2\3'),
                (ur'(?i)({{[\s_]*cita[ _](?:libro|noticia|publicación|web)[^}]*?(?:fecha|fechaacceso|fechaarchivo)\s*=\s*\d\d?)(?:[\s\-/]| de )(?:sept?(?:i[éeè]mbre)?|september|septembre)[\s\-/,]+([12]\d\d\d)(\s*[}\|])', ur'\1 de septiembre de \2\3'),
                (ur'(?i)({{[\s_]*cita[ _](?:libro|noticia|publicación|web)[^}]*?(?:fecha|fechaacceso|fechaarchivo)\s*=\s*\d\d?)(?:[\s\-/]| de )(?:oct[úuù]bre|o[ck]t(?:ober)?|octobre)[\s\-/,]+([12]\d\d\d)(\s*[}\|])', ur'\1 de octubre de \2\3'),
                (ur'(?i)({{[\s_]*cita[ _](?:libro|noticia|publicación|web)[^}]*?(?:fecha|fechaacceso|fechaarchivo)\s*=\s*\d\d?)(?:[\s\-/]| de )(?:nov(?:i[éeè]mbre)?|november|novembre)[\s\-/,]+([12]\d\d\d)(\s*[}\|])', ur'\1 de noviembre de \2\3'),
                (ur'(?i)({{[\s_]*cita[ _](?:libro|noticia|publicación|web)[^}]*?(?:fecha|fechaacceso|fechaarchivo)\s*=\s*\d\d?)(?:[\s\-/]| de )(?:dic(?:i[éeè]mbre)?|december|d[éeè]c(?:embre)?)[\s\-/,]+([12]\d\d\d)(\s*[}\|])', ur'\1 de diciembre de \2\3'),
